...
// export const bookInfo=(params)=>axios.get('/api/book',params)
// export const bookListen=(params)=>axios.get('/api/chapter',params)
// export const bookOne=(params)=>axios.pcget('/api/bookOne',params)
...
export const bookOne=(params)=>axios.pcget('https://www.tingxiaoshuo.cc/pc/index/getChapterUrl/bookId/'+params.bookId+'/chapterId/'+params.chapterId+'.html',{})
// export const bookOne=(params)=>axios.pcget('http://ts.kaizhu.xyz/api/bookOne',params)
